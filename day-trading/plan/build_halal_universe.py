...
def _restore_cause(rec):
    ...
    if src.startswith("upper-bound"):
        # name the ACTUAL rung: "(nonoperating income)" and "(max yield
        # on cash)" are different proofs and must not share a label.
        return f"{pre}{src}"
